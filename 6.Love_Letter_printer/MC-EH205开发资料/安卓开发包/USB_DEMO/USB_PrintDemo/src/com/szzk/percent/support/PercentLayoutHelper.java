...
package com.szzk.percent.support;
...
public class PercentLayoutHelper
{
    ...
    private void supportTextSize(int widthHint, int heightHint, View view, PercentLayoutInfo info)
    {
        ...
        //Button 闂佸憡绮ｉ幏锟� EditText 闂佸搫�?�弻鏉剎tView闂佹眹鍔�?�氼剟鎮哄▎鎴犲暗闁跨噦鎷�
    ...
    {
        //textSizePercent 婵帗绋掗�?�鍫ヮ敇缂佹顩烽柕澶嗘櫇瑜邦垶骞栨潏鍓х窗缂傚秵姊圭粙澶愬传閸曨厼鏁ら梺鍛婂�?閹凤�?
    ...
    {
        //婵帗绋掗�?�鍫ヮ敇缁浛rgin闂佸憡鐟ラ崐浠嬫晸閽樺鏆欐い鏃�姊归幆鏃堟晸閿燂拷
    ...
    /**
     * 闁荤姳绀佹晶浠嬫偪閸炴妺ddingPercent闂佺儵鏅濋�?�鍫ュ矗瑜忔禒锕傛�?�鏉堢偓瀚归柨鐕傛嫹
     *
     * @param array
     * @param info
     */
    ...
    {
        //婵帗绋掗�?�鍫ヮ敇缁Ψdding婵炲濮伴崕閬嶎敊閺冿拷閹棃鏁傞懗顖滎槹闂佸搫绉村ú銈夊闯閿燂拷
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
